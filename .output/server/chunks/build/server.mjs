import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { useSlots, ref, inject, computed, mergeProps, unref, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createVNode, toValue, getCurrentInstance, onServerPrefetch, watch, resolveDynamicComponent, toRef, provide, isRef, defineComponent, shallowRef, h, resolveComponent, useModel, createTextVNode, mergeModels, hasInjectionContext, nextTick, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, shallowReactive, Suspense, Fragment, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, withModifiers, getCurrentScope, markRaw, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { L as serialize, M as defu, N as klona, O as hasProtocol, P as isScriptProtocol, Q as joinURL, R as parseQuery, S as defuFn, T as withQuery, U as sanitizeStatusCode, V as parseURL, G as encodePath, W as decodePath, X as isEqual, Y as getContext, g as createError$1, Z as withTrailingSlash, _ as withoutTrailingSlash, $ as $fetch$1, a0 as baseURL, a1 as createHooks, a2 as executeAsync } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-IeI_cCdF.mjs')
  },
  {
    name: "admin-calls",
    path: "/admin/calls",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": "admin-auth" } },
    component: () => import('./calls-CkC0Bnb7.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": "admin-auth" } },
    component: () => import('./index-DmmKnM2W.mjs')
  },
  {
    name: "admin-login",
    path: "/admin/login",
    component: () => import('./login-DzZ5gG1-.mjs')
  },
  {
    name: "admin-accounts",
    path: "/admin/accounts",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "admin-auth" } },
    component: () => import('./accounts-BTt2pL9p.mjs')
  },
  {
    name: "admin-settings",
    path: "/admin/settings",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "admin-auth" } },
    component: () => import('./settings-B-H12Ntn.mjs')
  }
];
...
const namedMiddleware = {
  "admin-auth": () => import('./admin-auth-DVUySGPa.mjs')
};
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-Cm-eMvwu.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DzcQGS0R.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CaYKuY2N.mjs'));
...
export { _export_sfc as _, __nuxt_component_0 as a, useRuntimeConfig as b, _sfc_main$8 as c, useAsyncData as d, entry_default as default, useAppConfig as e, useButtonGroup as f, useComponentIcons as g, _sfc_main$d as h, _sfc_main$b as i, useLocale as j, usePortal as k, useToast as l, formBusInjectionKey as m, navigateTo as n, formErrorsInjectionKey as o, formInputsInjectionKey as p, formLoadingInjectionKey as q, formOptionsInjectionKey as r, inputIdInjectionKey as s, tv as t, useHead as u, formFieldInjectionKey as v, useFormField as w, looseToNumber as x, defineNuxtRouteMiddleware as y, useState as z };
