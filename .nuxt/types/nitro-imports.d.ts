declare global {
  ...
  const apiCallStats: typeof import('../../server/utils/call-log').apiCallStats
  ...
  const applyConfigToEnv: typeof import('../../server/utils/app-config').applyConfigToEnv
  const assertAdmin: typeof import('../../server/utils/admin-auth').assertAdmin
  ...
  const configFilePath: typeof import('../../server/utils/app-config').configFilePath
  const countApiCalls: typeof import('../../server/utils/call-log').countApiCalls
  ...
  const dispatchLegacyApi: typeof import('../../server/utils/legacy-dispatch').dispatchLegacyApi
  ...
  const getBearer: typeof import('../../server/utils/admin-auth').getBearer
  ...
  const listApiCalls: typeof import('../../server/utils/call-log').listApiCalls
  const logApiCall: typeof import('../../server/utils/call-log').logApiCall
  const mergeConfig: typeof import('../../server/utils/app-config').mergeConfig
  const nitroPlugin: typeof import('../../node_modules/nitropack/dist/runtime/internal/plugin').nitroPlugin
  const parseCookies: typeof import('../../node_modules/h3').parseCookies
  const promisifyNodeListener: typeof import('../../node_modules/h3').promisifyNodeListener
  const proxyRequest: typeof import('../../node_modules/h3').proxyRequest
  const readAppConfig: typeof import('../../server/utils/app-config').readAppConfig
  ...
  const syncTomlToSqlite: typeof import('../../server/utils/sync-config').syncTomlToSqlite
  ...
  const writeAppConfig: typeof import('../../server/utils/app-config').writeAppConfig
...
declare global {
  ...
  // @ts-ignore
  export type { AppConfig } from '../../server/utils/app-config'
  import('../../server/utils/app-config')
  // @ts-ignore
  export type { CallLogInput } from '../../server/utils/call-log'
  import('../../server/utils/call-log')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'H:/Documents/GitHub/dreamine2api/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'H:/Documents/GitHub/dreamine2api/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { getBearer, assertAdmin } from 'H:/Documents/GitHub/dreamine2api/server/utils/admin-auth';
export { configFilePath, readAppConfig, writeAppConfig, mergeConfig, applyConfigToEnv } from 'H:/Documents/GitHub/dreamine2api/server/utils/app-config';
export { logApiCall, listApiCalls, countApiCalls, apiCallStats } from 'H:/Documents/GitHub/dreamine2api/server/utils/call-log';
export { dispatchLegacyApi } from 'H:/Documents/GitHub/dreamine2api/server/utils/legacy-dispatch';
export { syncTomlToSqlite } from 'H:/Documents/GitHub/dreamine2api/server/utils/sync-config';